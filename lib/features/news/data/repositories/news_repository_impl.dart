import 'package:forestvpn_test/features/news/data/models/article_model.dart';
...
class NewsRepositoryImpl implements INewsRepository {
  NewsRepositoryImpl() {
    _mockArticles.addAll(ArticleModel().generateFakeList(length: 30));
    _mockLatestArticles.addAll(ArticleModel().generateFakeList(length: 1));
  }

  final List<Article> _mockArticles = [];
  final List<Article> _mockLatestArticles = [];

  @override
  Future<List<Article>> getLatestArticles() async {
    return _mockLatestArticles;
  }
